...
function currentTime() {
  ...
  if (day === 1) {
    var subjects = ["ทัศนศิลป์ 1 (1/4)", "ทัศนศิลป์ 3 (2/9)", "ดนตรีไทยพื้นฐาน (1/7)", "พักกลางวัน", "ทัศนศิลป์ 1 (1/5)", "เตรียมสอน", "เตรียมสอน", "โฮมรูม (5/4)"]
  } else if (day === 2) {
    var subjects = ["พื้นฐานขลุ่ยเพียงออ 1 (2/7)", "ทัศนศิลป์ 1 (1/1)", "เตรียมสอน", "พักกลางวัน", "ทัศนศิลป์ 1 (1/7)", "ดนตรีไทยพื้นฐาน (1/8)", "เตรียมสอน", " โฮมรูม (5/4)"]
  } else if (day === 3) {
    var subjects = ["ทัศนศิลป์ 1 (1/8)", "เตรียมสอน", "เตรียมสอน", "พักกลางวัน", "ทัศนศิลป์ (1/6)", "พื้นฐานขลุ่ยเพียงออ 1 (2/8)", "ทัศนศิลป์ 1 (1/3)", "ลูกเสือ"]
  } else if (day === 4) {
    ...
    var subjects = ["พื้นฐานขลุ่ยเพียงออ 1 (2/9)", "เตรียมสอน", "เตรียมสอน", "พักกลางวัน", "เตรียมสอน", "ดนตรีไทยพื้นฐาน (1/7)", "ดนตรีไทยพื้นฐาน (1/8)", "คุณธรรม"]
  } else {
