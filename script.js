...
function currentTime() {
  ...
  if (day === 1) {
    ...
    var subjects = ["พื้นฐานขลุ่ยเพียงออ 1 (2/7)", "ทัศนศิลป์ 1 (1/1), เตรียมสอน", "พักกลางวัน", "เตรียมสอน", "ทัศนศิลป์ (1/8)", "ทัศนศิลป์ 1(1/7), โฮมรูม (5/4)"]
  } else if (day === 3) {
    ...
    var subjects = ["พื้นฐานขลุ่ยเพียงออ 1 (2/9), เตรียมสอน", "ดนตรีไทยพื้นฐาน (1/7)", "พักกลางวัน", "เตรียมสอน", "เตรียมสอน", "ดนตรีไทยพื้นฐาน (1/8)", "คุณธรรม"]
  } else {
